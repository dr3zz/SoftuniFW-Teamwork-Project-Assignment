...
class DBSession extends \SoftUniFW\DB\SimpleDB implements \SoftUniFW\Sessions\ISession
{
    ...
    function __construct($dbConnection, $name, $tableName = 'session', $lifetime = 3600, $path = null, $domain = null, $secure = false)
    {
